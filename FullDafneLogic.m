...
clear;
clear DafnePID; %reset static vars (errors)
close all;
clc;

testAStar;%Launch planner
clear i coords orient goal ss sv garden planner refpath;%clear unnecesary vars from planner
...
pause_time = 0.01; % = time_step woul be realistic
simulation_time = 80;       % Total simulation time [s]
...
for step = 1:num_steps
    ...
    [v, omega] = DafnePID(gainStruct,traj(pathPoint,:),estimated_state,time_step);
