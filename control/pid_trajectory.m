...
trajectory_type = 'sinusoidal';  % Options: 'circular', 'sinusoidal'
...
sgtitle(sprintf('Unicycle Vehicle Trajectory Tracking with PID Controller - %s', trajectory_type), 'Interpreter', 'latex');